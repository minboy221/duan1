                                    ...
                                    <tr>
                                        <td>
                                            <?php if (!empty($item['image'])): ?>
                                                <img src="<?= BASE_URL ?>uploads/<?= htmlspecialchars($item['image']) ?>" width="80" style="border-radius:8px">
                                            <?php else: ?>
                                        ...
                                        <td>
                                            <a class="btnsua" href="?act=edit_dichvu&id=<?= htmlspecialchars($item['id']) ?>">Sửa</a>
                                            <a class="btnxem" href="?act=show_dichvu&id=<?= htmlspecialchars($item['id']) ?>">Xem</a>
                                            <a class="btnxoa"
